...
public class LessThanExpression extends NumericJsonPathBasedExpression {
    ...
    @Builder
    public LessThanExpression(String path, Number value, boolean defaultResult, List<PreOperation<?>> preoperations) {
        super(ExpressionType.less_than, path, value, defaultResult, preoperations);
    }

    public LessThanExpression(String path, Number value, List<PreOperation<?>> preoperations) {
