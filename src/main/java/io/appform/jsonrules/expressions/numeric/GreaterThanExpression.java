...
public class GreaterThanExpression extends NumericJsonPathBasedExpression {
    ...
    @Builder
    public GreaterThanExpression(String path, Number value, boolean defaultResult, List<PreOperation<?>> preoperations) {
        super(ExpressionType.greater_than, path, value, defaultResult, preoperations);
    }

    public GreaterThanExpression(String path, Number value, List<PreOperation<?>> preoperations) {
